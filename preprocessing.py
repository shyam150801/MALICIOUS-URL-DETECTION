...
def get_graph_feature():
    graph_feature_train_data_path = "./graph_feature/reentrancy/reentrancy_final_train_clean.txt"
    graph_feature_train_label_path = "./graph_feature/reentrancy/label_by_experts_train.txt"

    graph_feature_test_data_path = "./graph_feature/reentrancy/reentrancy_final_test_clean.txt"
    ...
    for label in labels:
        label_by_experts_train.append(label.strip('\n'))# removes the newline character, appends the cleaned label to the corresponding list
    ...
    graph_feature_train_list = np.loadtxt(graph_feature_train_data_path,delimiter=" ",dtype=float)
    graph_feature_train = graph_feature_train_list.tolist()
    graph_feature_test_list = np.loadtxt(graph_feature_test_data_path,delimiter=" ",dtype=float)
    graph_feature_test = graph_feature_test_list.tolist()
